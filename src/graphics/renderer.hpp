...
public:
    ...
    void draw(const Texture& texture, const Rectangle& region, const glm::vec2& position, float scale);
    void draw(const Texture& texture, const Rectangle& region, const glm::vec2& position);
